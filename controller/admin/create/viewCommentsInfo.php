                                ...
                                <div class="media-body">
                                    ...
                                    <div class="w-100">
                                        <div class="md-form form-group green-border-focus my-0">
                                            <textarea cols="50" rows="1" class="textareaElement w-100 md-textarea form-control" required placeholder="Agregar comentario" id="'.$publication.'" maxlength="4000" contenteditable></textarea>
                                        </div>
