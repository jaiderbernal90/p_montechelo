            ...
            <div class="container-fluid mt-5">
                <ul class="nav nav-tabs nav-justified" style="font-size: 17px;">
                    <li role="presentation" class="active li-men" >
                        <a href="" class="link-pub">Lista</a>
                    </li>
                    <li role="presentation" class="li-men">
                        <a href="calendar.php" class="link-pub link-pub-reac">Calendario</a>
                    </li>
                </ul>
            </div>
        </div>
        ...
        <div class="row p-0 m-0 w-100 mb-5 birth">
            <div class="col-12 col-md-6 col-lg-4 p-0">
                ...
                <div id="card-1" class="card card-rotating text-center">
                    ...
                    <!-- Content -->
                    <div class="card-body">
                        <h4 class="font-weight-bold mb-3">Juan Beltran</h4>
                        <p class="font-weight-bold blue-text">Programador</p>
                        <!-- Triggering button -->
