   ...
   <!--Navbar-->
    ...
    <section class="container-fluid w-100 p-0 m-0 mt-5">
        <div class="row w-100 m-0 p-0 mt-5">
            <div class="col-12 p-0 mt-5 d-flex">
                <h4 class="title-section m-auto">Actualizar Anuncio</h4>
            </div>
        </div>
    </section>
    <section class="container-fluid w-100 p-0 m-0">
        <div class="row w-100 m-0 p-0 ">
            <div class="col-12">
                <form action="../../controller/admin/update/updateAnunce.php" method="POST" enctype="multipart/form-data" class="form m-4 m-md-5">
                    <?php
                        $id=$_POST['id'];
                        ...
                        <div class="col-12">               
                           <div class="form-row d-flex mt-5">
                                   <div class="col-5 text-md-right text-center">
                                       <button type="button" class="btn btn-info" ><a class="text-white" href="publicaciones.php">Volver</a></button>
                                   </div> 
