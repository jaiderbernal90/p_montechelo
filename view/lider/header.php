<?php require_once('../../controller/translation/roles.php') ?>
<!--Navbar-->
<nav class="navbar navbar-dark amber menu-bar fixed-top">
    ...
    <main class="navbar-toggler d-flex">
        ...
        <!-- Message and user -->
            <ul class="navbar-nav ml-auto nav-flex-icons">
                    <p class="text-dark pt-4 text-menu  d-none d-lg-block"><?php echo strtoupper($_SESSION['name']).' '.strtoupper($_SESSION['last_name']); ?> </p>
                    <li class="nav-item">
    ...
    <div class="collapse navbar-collapse li-menu" id="navbarSupportedContent22">
        ...
        <div class="text-center sec-respon pt-3 d-block d-lg-none">
            ...
            <div class="mb-3">
                <p class="text-menu mb-0"> <?php echo strtoupper($_SESSION['name']).' '.strtoupper($_SESSION['last_name'])?> </p>
                <div class="sub-text">
