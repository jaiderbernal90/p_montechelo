                    ...
                    <main class="cont-card-user shadow">
                        <div class="mask d-flex">
                            <header class="img-cont">
                                <a href="moreRepositorio.php"><img src="../../img/adult-1868750_640.jpg" alt=""></a>
                            </header>
                            <div class="text-center title-card-rep">
                                <a href="moreRepositorio.php" class="m-auto"><i class="fas fa-plus hov fa-2x"></i></a>
                                <h3>JUAN PEREZ</h3>
        ...
        <div class="row w-100 m-0 p-0 mt-5">
            <div class="col-12 p-0 mt-3">
                    <main class="cont-card-user shadow">
                        <div class="mask d-flex">
                            <header class="img-cont">
                                <a href="moreRepositorio.php"><img src="../../img/user.png" alt=""></a>
                            </header>
                            <div class="text-center title-card-rep">
                                <a href="moreRepositorio.php" class=""><i class="fas fa-plus fa-2x hov"></i></a>
        ...
        <div class="row w-100 m-0 p-0 mt-5">
            <div class="col-12 p-0 mt-3">
                    <main class="cont-card-user shadow">
                        <div class="mask d-flex">
                            <header class="img-cont">
                                <a href="moreRepositorio.php"><img src="../../img/beard-1845166_640.jpg" alt=""></a>
                            </header>
                            <div class="text-center title-card-rep">
                                <a href="moreRepositorio.php" class=""><i class="fas fa-plus hov fa-2x"></i></a>
                                <h3>PEPITO PEREZ</h3>
                                <span>Administrador</span>
                            </div>
                        </div>
